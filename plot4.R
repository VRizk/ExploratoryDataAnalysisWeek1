...
par (mfrow = c(2,2))
with(data_set, {
        plot(data_set$complete_date, data_set$Global_active_power, type = "l", col = "black", xlab ="", ylab = "Global Active Power")
        plot(data_set$complete_date, data_set$Voltage, type = "l", col = "black", xlab = "datetime", ylab = "Voltage")
        plot(data_set$complete_date, data_set$Sub_metering_1, type = "l", col = "black", xlab = "", ylab = "Energy sub metering")
        ...
        plot(data_set$complete_date, data_set$Global_reactive_power, type = "l", col = "black", xlab = "datetime", ylab = "Global_reactive_power")
})
        dev.off()